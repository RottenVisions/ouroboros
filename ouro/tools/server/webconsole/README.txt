...
1.请自行为你所使用的python安装与之匹配的django模块；
  ...
  1.1.1.如果使用的是python2.6.6：可以选择进入到“ouro/tools/server/django_packages”目录，并在该目录下解压Django-1.6.11.tar.gz文件（解压到当前目录）
  1.1.2.如果使用的是python2.7或以上：可以选择进入到“ouro/tools/server/django_packages”目录，并在该目录下解压Django-1.8.9.tar.gz文件（解压到当前目录）
