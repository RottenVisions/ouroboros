    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(serialize=False, primary_key=True)),
                                ('name', models.CharField(default='', unique=True, db_index=True, help_text='Account Name', max_length=128)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                                ('sys_user', models.CharField(default='', help_text='System Account', max_length=128)),
                                ('config', models.TextField(default='', help_text='Set(JSON)', max_length=32768)),
            ],
        ),
    ]
