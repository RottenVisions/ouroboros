...
/*
	Binary data stream module
	Ability to serialize (writeXXX) some basic types into binary streams and also provide operations such as deserialization (readXXX)
*/
class OUROBOROSPLUGINS_API MemoryStream
{
public:
