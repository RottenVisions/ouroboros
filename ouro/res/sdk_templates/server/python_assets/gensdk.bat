...
cd %curpath%
start "" "%OURO_BIN_PATH%/obcmd.exe" --clientsdk=unity --outpath="%curpath%/ouroboros_unity3d_plugins"
start "" "%OURO_BIN_PATH%/obcmd.exe" --clientsdk=ue4 --outpath="%curpath%/ouroboros_ue4_plugins"