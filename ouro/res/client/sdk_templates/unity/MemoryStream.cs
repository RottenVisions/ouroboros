namespace Ouroboros
{
	...
	/*
		The binary data stream module
		Can be some basic type of serialization(writeXXX)into a binary stream also provides deserialize(readXXX)and other operations
	*/
