...
class XMLRPCTestCase(unittest.TestCase):
    ...
    def test_load_standard_types(self):
        ...
        check('<string>ð?”˜ð?”«ð?”¦ð?” ð?”¬ð?”¡ð?”¢ string</string>', 'ð?”˜ð?”«ð?”¦ð?” ð?”¬ð?”¡ð?”¢ string')
...
def http_server(evt, numrequests, requestHandler=None, encoding=None):
    ...
    try:
        ...
        serv.register_function(lambda x: x, 'tÃªÅ¡t')
...
class SimpleServerTestCase(BaseServerTestCase):
    ...
    def test_nonascii_methodname(self):
        try:
            ...
            self.assertEqual(p.tÃªÅ¡t(42), 42)
        except (xmlrpclib.ProtocolError, socket.error) as e:
            # ignore failures due to non-blocking socket unavailable errors.
            if not is_unavailable_exception(e):
                # protocol error; provide additional information in test output
    ...
    def test_introspection1(self):
        expected_methods = set(['pow', 'div', 'my_function', 'add', 'tÃªÅ¡t',
