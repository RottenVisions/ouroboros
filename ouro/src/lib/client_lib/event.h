...
#ifndef OURO_CLIENT_EVENT_H
#define OURO_CLIENT_EVENT_H
...
{
public:
	virtual void ouroboros_onEvent(const EventData* lpEventData) = 0;
};
...
inline EventData* newOuroborosEvent(EventID v)
{
	switch(v)
	{
...
inline EventData* copyOuroborosEvent(const Ouroboros::EventData* lpEventData)
{
	Ouroboros::EventData* peventdata = NULL;
