...
#ifndef OURO_REDIS_DB_RW_CONTEXT_H
#define OURO_REDIS_DB_RW_CONTEXT_H
...
/**
	...
	dbids: There is only one dbid in the dbids on the main table, which is the id of the entity. If the entity data exists in the array class, there will be a sub-table, when the data structure describes a sub-table
		dbidsIt is the index of the sub-table of this array. Each dbid represents the corresponding value on this sub-table and also represents the value of the corresponding position in the array according to the arrangement order.
		dbids = {
	...
	results: The data queried during the read operation, the data arrangement corresponds to the number of strkeys in the item multiplied by the number of dbids.
...
#endif // OURO_REDIS_DB_RW_CONTEXT_H
