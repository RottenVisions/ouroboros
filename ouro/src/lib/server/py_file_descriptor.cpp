...
PyObject* PyFileDescriptor::__py_registerReadFileDescriptor(PyObject* self, PyObject* args)
{
	...
	{
		PyErr_Format(PyExc_TypeError, "Ouroboros::registerReadFileDescriptor: args != (fileDescriptor, callback)!");
		PyErr_PrintEx(0);
		return NULL;
	}
	...
	if(fd <= 0)
	{
		PyErr_Format(PyExc_TypeError, "Ouroboros::registerReadFileDescriptor: fd <= 0!");
		PyErr_PrintEx(0);
		return NULL;
	}
	...
	{
		PyErr_Format(PyExc_TypeError, "Ouroboros::registerReadFileDescriptor: invalid pycallback!");
		PyErr_PrintEx(0);
		return NULL;
	}
...
PyObject* PyFileDescriptor::__py_deregisterReadFileDescriptor(PyObject* self, PyObject* args)
{
	...
	{
		PyErr_Format(PyExc_TypeError, "Ouroboros::deregisterReadFileDescriptor: args != (fileDescriptor)!");
		PyErr_PrintEx(0);
		return NULL;
	}
	...
	if(fd <= 0)
	{
		PyErr_Format(PyExc_TypeError, "Ouroboros::deregisterReadFileDescriptor: fd <= 0!");
		PyErr_PrintEx(0);
		return NULL;
	}
...
PyObject* PyFileDescriptor::__py_registerWriteFileDescriptor(PyObject* self, PyObject* args)
{
	if(PyTuple_Size(args) != 2)
	{
		PyErr_Format(PyExc_TypeError, "Ouroboros::registerWriteFileDescriptor: args != (fileDescriptor, callback)!");
		PyErr_PrintEx(0);
		return NULL;
	}
	...
	if(fd <= 0)
	{
		PyErr_Format(PyExc_TypeError, "Ouroboros::registerWriteFileDescriptor: fd <= 0!");
		PyErr_PrintEx(0);
		return NULL;
	}
	...
	if(!PyCallable_Check(pycallback))
	{
		PyErr_Format(PyExc_TypeError, "Ouroboros::registerWriteFileDescriptor: invalid pycallback!");
		PyErr_PrintEx(0);
		return NULL;
	}
...
PyObject* PyFileDescriptor::__py_deregisterWriteFileDescriptor(PyObject* self, PyObject* args)
{
	if(PyTuple_Size(args) != 1)
	{
		PyErr_Format(PyExc_TypeError, "Ouroboros::deregisterWriteFileDescriptor: args != (fileDescriptor)!");
		PyErr_PrintEx(0);
		return NULL;
	}
	...
	if(fd <= 0)
	{
		PyErr_Format(PyExc_TypeError, "Ouroboros::deregisterWriteFileDescriptor: fd <= 0!");
		PyErr_PrintEx(0);
		return NULL;
	}
