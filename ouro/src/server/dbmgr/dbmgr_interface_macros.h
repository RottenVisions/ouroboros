// 2017-2018 Rotten Visions, LLC. https://www.rottenvisions.com
	...
	#undef OURO_DBMGR_INTERFACE_MACRO_H
#endif
...
#define DBMGR_MESSAGE_HANDLER_STREAM(NAME)										\
	...
	{																			\
			Ouroboros::Dbmgr::getSingleton().NAME(pChannel, s);					\
	}																			\
...
#define DBMGR_MESSAGE_HANDLER_ARGS0(NAME)										\
	void NAME##DbmgrMessagehandler0::handle(Network::Channel* pChannel,			\
												Ouroboros::MemoryStream& s)		\
	{																			\
			Ouroboros::Dbmgr::getSingleton().NAME(pChannel);						\
	}																			\
...
#define DBMGR_MESSAGE_HANDLER_ARGS1(NAME, ARG_TYPE1, ARG_NAME1)					\
	...
	{																			\
			ARG_TYPE1 ARG_NAME1;												\
			s >> ARG_NAME1;														\
			Ouroboros::Dbmgr::getSingleton().NAME(pChannel, ARG_NAME1);			\
	}																			\
...
/**
	Dbmgr message macro, message with only three parameters
*/
#if defined(NETWORK_INTERFACE_DECLARE_BEGIN)
...
/**
	Dbmgr message macro, message with only four parameters
*/
#if defined(NETWORK_INTERFACE_DECLARE_BEGIN)
...
/**
	Dbmgr message macro, message with only six parameters
*/
#if defined(NETWORK_INTERFACE_DECLARE_BEGIN)
...
/**
	Dbmgr message macro, message with only eight parameters
*/
#if defined(NETWORK_INTERFACE_DECLARE_BEGIN)
...
/**
	Dbmgr message macro, message with only nine parameters
*/
#if defined(NETWORK_INTERFACE_DECLARE_BEGIN)
