...
{
	// If the list is empty, the initial first and last xz node is the node
	if(isEmpty())
	{
...
bool CoordinateSystem::remove(CoordinateNode* pNode)
{
	...
	// Because the COORDINATE_NODE_FLAG_PENDING flag may be cancelled during the update process due to the multi-level update, this is not a good judgment here.
