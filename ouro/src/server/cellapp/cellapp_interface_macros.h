// 2017-2018 Rotten Visions, LLC. https://www.rottenvisions.com
	...
	#undef OURO_CELLAPP_INTERFACE_MACRO_H
#endif
...
#define CELLAPP_MESSAGE_HANDLER_STREAM(NAME)									\
	...
	{																			\
			Ouroboros::Cellapp::getSingleton().NAME(pChannel, s);				\
	}																			\
...
#define CELLAPP_MESSAGE_HANDLER_ARGS0(NAME)										\
	void NAME##CellappMessagehandler0::handle(Network::Channel* pChannel,		\
												Ouroboros::MemoryStream& s)		\
	{																			\
			Ouroboros::Cellapp::getSingleton().NAME(pChannel);					\
	}																			\
...
#define CELLAPP_MESSAGE_HANDLER_ARGS1(NAME, ARG_TYPE1, ARG_NAME1)				\
	...
	{																			\
			ARG_TYPE1 ARG_NAME1;												\
			s >> ARG_NAME1;														\
			Ouroboros::Cellapp::getSingleton().NAME(pChannel, ARG_NAME1);		\
	}																			\
...
/**
	Cellapp message macro, message with only two parameters
*/
#if defined(NETWORK_INTERFACE_DECLARE_BEGIN)
...
/**
	Cellapp message macro, message with only three parameters
*/
#if defined(NETWORK_INTERFACE_DECLARE_BEGIN)
...
/**
	Cellapp message macro, message with only four parameters
*/
#if defined(NETWORK_INTERFACE_DECLARE_BEGIN)
...
/**
	Cellapp message macro, message with only eight parameters
*/
#if defined(NETWORK_INTERFACE_DECLARE_BEGIN)
...
/**
	Cellapp message macro, message with only nine parameters
*/
#if defined(NETWORK_INTERFACE_DECLARE_BEGIN)
