...
{
	ouro_snprintf(s, size, "clientEntityComponent id:%d, srcEntityID=%d.", pClientEntity_->clientEntityID(), pClientEntity_->srcEntityID());
}
...
{
	ouro_snprintf(s, size, "clientEntity id:%d, srcEntityID=%d.", clientEntityID_, srcEntityID_);
}
